...
@Component({
  selector: 'app-viewtime-widget',
  templateUrl: './viewtime-widget.component.html',
  styleUrls: ['./viewtime-widget.component.css']
})
export class ViewTimeWidgetComponent implements OnInit {
